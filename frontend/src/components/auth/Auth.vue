<template>
    <div class="auth-content">
        <div class="auth-modal">
            ...
            <input type="text" name="nome" v-if="showSignup" v-model="user.name" placeholder="Nome">
            ...
            <input type="password" name="confirmPassword" v-if="showSignup" v-model="user.confirmPassword" placeholder="Confirme a senha">
